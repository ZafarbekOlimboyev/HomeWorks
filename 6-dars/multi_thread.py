...
def write_html(html_code, html_name):
    with open(f"./multi_t/{html_name}.html", "w") as h:
        h.write(html_code)

if __name__ == "__main__":
    start_time = time.time_ns() // 1_000_000
    url_base = "https://multimediya.uz/e-kitob/index.php?mavzu="
    urls = [f"{url_base}{i}" for i in range(1, 14)]
...
# 1903 millisekundda yuklab olindi.